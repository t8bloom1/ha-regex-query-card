...
let HaRegexQueryCard = class HaRegexQueryCard extends i {
    ...
    _getEntityIcon(entity) {
        ...
        const friendlyName = (((_c = entity.attributes) === null || _c === void 0 ? void 0 : _c.friendly_name) || '').toLowerCase();
...
console.info(`%c  REGEX-QUERY-CARD  %c  v2.0.0  `, 'color: orange; font-weight: bold; background: black', 'color: white; font-weight: bold; background: dimgray');
